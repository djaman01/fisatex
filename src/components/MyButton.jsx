const MyButton = ({label, iconURL, fullWidth}) => {
  return (
    ...
    <button
      className={`flex items-center justify-center gap-2 h-14 rounded-full border border-coral-red bg-coral-red px-7 py-4 font-montserrat text-xl leading-none text-white ${fullWidth && "w-full"}`}
    >
      {label}
